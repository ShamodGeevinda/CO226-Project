                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Add Customers</a></li>
                        </ol>
                    </nav>
                </div>
                ...
                <form action="add_customer.php" method="POST">
                    <div class="form-row">
                        <div class="col-md-6 mb-6">
                            ...
                            <input type="text" class="form-control" id="validationDefault01" placeholder="User Name" name="UserName" required>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <input type="text" class="form-control" id="validationDefault02" placeholder="Address" name="Address" required>
                        </div>

                        <div class="col-md-4 mb-4">
                            <label for="validationDefault02">NIC</label>
                            <input type="text" class="form-control" id="validationDefault02" placeholder="NIC" name="NIC" required>
                        </div>
                    </div>
                    ...
                    <button class="btn btn-primary mt-3" type="submit">Add Customer Details</button>
                </form>
                ...
                <div class="table-responsive">
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT UserName, ContactNum, Address, NIC  FROM Customer ORDER BY CustomerID desc"; // order bi id in descending order
