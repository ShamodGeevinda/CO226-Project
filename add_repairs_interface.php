    ...
    <div class="main-container" id="container">
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Add repairs</a></li>
                        </ol>
                    </nav>
                </div>
                ...
                <form action="add_repairs.php" method="POST">
                    <div class="form-row">
                        <div class="col-md-6 mb-6">
                            <label for="validationDefault01">Date of Completion</label>
                            <input type="text" class="form-control" id="validationDefault01" placeholder="YYYY - MM - DD" name="DateofCompletion" required>
                        </div>


                        <div class="col-md-6 mb-6">
                            <label for="validationDefault02">Employee ID</label>
                            <input type="text" class="form-control" id="myInput" placeholder="Employee ID" name="EmpID" required>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-8">
                            ...
                            <input type="text" class="form-control" id="validationDefault01" placeholder="Description" name="Description" required>
                        </div>
                    ...
                    <button class="btn btn-primary mt-3" type="submit">Add New Repair Details</button>
                </form>
                ...
                <div class="table-responsive">
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT ReciptNum, Status, DateofCompletion, Description,EmpID  FROM Repair ORDER BY ReciptNum desc"; // order by id in descending order
