                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Add Stocks</a></li>
                        </ol>
                    </nav>
                </div>
                ...
                <form action="add_stocks.php" method="POST">
                    <div class="form-row">
                        <div class="col-md-6 mb-6">
                            ...
                            <input type="text" class="form-control" id="validationDefault01" placeholder="Part Name" name="PartName" required>
                        </div>


                        <div class="col-md-6 mb-6">
                            <label for="validationDefault02">Manufacture ID</label>
                            <input type="text" class="form-control" id="validationDefault02" placeholder="Manufacture ID" name="ManufactureID" required>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-4">
                            ...
                            <input type="text" class="form-control" id="validationDefault01" placeholder="Unit Price" name="UnitPrice" required>
                        </div>
                        <div class="col-md-4 mb-4">
                        ...
                        <div class="col-md-4 mb-4">
                            <label for="validationDefault02">Warranty Duration</label>
                            <input type="text" class="form-control" id="validationDefault02" placeholder="Warranty Duration" name="WarrantyDuration" required>
                        </div>
                    </div>
                    ...
                    <button class="btn btn-primary mt-3" type="submit">Add Stock Details</button>
                </form>
                ...
                <div class="table-responsive">
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM stock ORDER BY PartID desc"; // order bi id in descending order
