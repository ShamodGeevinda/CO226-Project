...
<body class="dashboard-sales">
                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Task Details</a></li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="table-responsive">
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT Task_Date, FirstName, LastName, Task_Description FROM daily_task, employee WHERE daily_task.EmployeeID = employee.EmployeeID  ORDER BY Task_Date DESC"; // order bi id in descending order
    ...
    <script>
        $('#html5-extension').DataTable({
            ...
            // this will make data order descending
            "order": [
                [0, "desc"]
            ],
            "stripeClasses": [],
